...
Genera una pagina HTML con gli eventi di DaddyLive + Karmakurama.
Apre i link in nuova pagina (no iframe).
"""
...
# ====== CONFIG ======
TIME_OFFSET_HOURS = 2      # +2 ore per l'Italia
...
try:
    response = requests.get(url_daddy, headers=headers, timeout=15, verify=False)  # ✅ SSL disabilitato
